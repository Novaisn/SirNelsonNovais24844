...
$INSTRUCAO = $pdo->prepare('SELECT id, texto, estado  from sobremim');
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($texto_err)){
        ...
        $sql = "INSERT INTO sobremim (texto) VALUES (:texto)";
         
        if($stmt = $pdo->prepare($sql)){
            $stmt->bindParam(":texto", $param_texto, PDO::PARAM_STR);
            $param_texto = $texto;
            if($stmt->execute()){
...
<?php require_once "../../utils/navbar.php"; ?>
  ...
  <div class="container">
    ...
    <div class="row mt-5 pt-5">
      <div class="col-12">
          <div class="display-4">Listar Sobre MIM</div>
      </div>
    </div>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-outline mb-4">
                                            <textarea type="text" name="texto" class="form-control form-control-lg <?php echo (!empty($nome_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $texto; ?>"></textarea>
                                            <span class="invalid-feedback"><?php echo $texto_err; ?></span>
