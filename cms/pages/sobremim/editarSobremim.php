...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM sobremim WHERE id=:id";
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty(trim($_POST["texto"]))){
        ...
        if(empty($texto_err)) {
            ...
            $sql = "UPDATE sobremim SET texto=:texto WHERE id=:id";
            $stmt = $pdo->prepare($sql);
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-12 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <button onclick="window.location.href='listarSobremim.php'" class="btn btn-primary w-25 mb-5">
                                    Voltar
                                </button>

                                <form action="editarSobremim.php?id=<?php echo $_GET['id']; ?>" method="post">
                                    <h5 class="fw-normal mb-3 pb-3 letterSp">Editar Sobremim</h5>
                                    
                                    <!-- username input -->
                                    <div class="form-outline mb-4">
                                        <input type="text" name="texto" class="form-control form-control-lg <?php echo (!empty($nome_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $inicio['texto']; ?>" required>
