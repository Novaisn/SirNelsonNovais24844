...
$INSTRUCAO = $pdo->prepare('SELECT id, titulo, img, estado  from certificacoes');
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    if(empty($titulo_err) && $uploadOk != 0){
        
        $sql = "INSERT INTO certificacoes (titulo, img) VALUES (:titulo, :img)";
...
<?php require_once "../../utils/navbar.php"; ?>
  ...
  <div class="container">
    ...
    <div class="row mt-5 pt-5">
      <div class="col-12">
          <div class="display-4">Listar Certificações</div>
      </div>
    </div>
      ...
      <div class="col-12">
        ...
        <table class='table'>
          ...
          ?>
            <?php if($row['estado'] == 0){
              echo "<th>";?>
            <a href="ativarCertificacao.php?id=<?php echo $row['id'];?>">
          ...
          <?php echo "</th>";?>
              ...
              <th>
              <a href="editarCertificacao.php?id=<?php echo $row['id'];?>">
              <button type="button" class="btn btn-primary"><i class="fa-solid fa-square-pen"></i></button></a>
            </th><th><a href="deleteCertificacao.php?id=<?php echo $row['id'];?>">
          ...
          <?php if($row['estado'] == 1){
            echo "<th>";?>
            <a href="desativarCertificacao.php?id=<?php echo $row['id'];?>">
                            ...
                            <div class="col-md-6 col-lg-12 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                        <h5 class="fw-normal mb-3 pb-3 letterSp">Criar Certificação</h5>
