...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Check if the username that was submitted, is already taken by another user
        ...
        if(empty($percentagem_err) && empty($titulo_err)) {
            ...
            $sql = "UPDATE idiomas SET percentagem=:percentagem, titulo=:titulo WHERE id=:id";
            $stmt = $pdo->prepare($sql);
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-12 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <button onclick="window.location.href='listarIdioma.php'" class="btn btn-primary w-25 mb-5">
                                    Voltar
                                </button>

                                <form action="editarIdioma.php?id=<?php echo $_GET['id']; ?>" method="post">
                                    <h5 class="fw-normal mb-3 pb-3 letterSp">Editar Idioma</h5>
                                    ...
                                    <!-- username input -->
                                    <div class="form-outline mb-4">
                                        <input type="number" min="0" name="percentagem" class="form-control form-control-lg <?php echo (!empty($percentagem_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $inicio['percentagem']; ?>" required>
