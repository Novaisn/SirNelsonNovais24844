...
$INSTRUCAO = $pdo->prepare('SELECT id, titulo, percentagem ,estado  from hardskills');
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($titulo_err) && empty($percentagem_err)){
        ...
        $sql = "INSERT INTO hardskills (titulo, percentagem) VALUES (:titulo, :percentagem)";
...
<?php require_once "../../utils/navbar.php"; ?>
  ...
  <div class="container">
    ...
    <div class="row mt-5 pt-5">
      <div class="col-12">
          <div class="display-4">Listar Hard Skills</div>
      </div>
    </div>
    ...
    <div class="row my-5">
      <div class="col-12">
        ...
        <table class='table'>
          ...
          <?php if($row['estado'] == 1){
            echo "<th>";?>
            <a href="desativarHardskills.php?id=<?php echo $row['id'];?>">
        ...
        <?php echo "</th>";?>
            ...
            <th>
            <a href="editarHardskills.php?id=<?php echo $row['id'];?>">
            <button type="button" class="btn btn-primary"><i class="fa-solid fa-square-pen"></i></button></a></th><th>
              <a href="deleteHardskills.php?id=<?php echo $row['id'];?>">
            <button type="button" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></button></a></a></th>
                            ...
                            <div class="col-md-6 col-lg-12 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                        <h5 class="fw-normal mb-3 pb-3 letterSp">Novo Hard Skills</h5>
                                    
                                        <!-- username input -->
                                        <div class="form-outline mb-4">
                                            <input type="number" min="0" max="100" name="percentagem" class="form-control form-control-lg <?php echo (!empty($percentagem_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $percentagem; ?>">
